...
// abi(application binary interface)는 블록체인 외부 - Contract 또는 contract - contract 간에 인터렉션 하기 위한 표준 방법입니다.
// 컨트랙트 코드가 인코딩되어 있습니다.
// encodeWithSignature 함수를 이용해 외부 컨트랙트 함수를 호출할 수 있습니다.
...
contract caller {
    ...
    function callMethod(
        ...
        (bool success, bytes memory outputFromCalledFunction) = _contractAddr
            .call(
