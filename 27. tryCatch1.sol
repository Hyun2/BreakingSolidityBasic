...
외부 스마트 컨트랙트의 함수를 부를때 : 다른 스마트 컨트랙을 인스턴스화 하여서, try/catch문이 있는 스마트 컨트랙의 함수를 불러와서 사용.
외부 스마트 컨트랙트를 생성 할 때 : 다른 스마트컨트랙을 인스턴스화 생성 할 때 씀
...
contract runner {
    ...
    {
        // mathInstance.division(_num1, _num2) 결과가 value 변수에 저장됩니다.
